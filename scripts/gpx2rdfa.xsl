 ...
 <!-- width="640" height="640" -->
    ...
    <xsl:template match="gpx/trk/trkseg">
        <thead about="structure/{$dataset}" typeof="qb:DataStructureDefinition">
            <tr>
                <th rel="qb:component" resource="component/{$dataset}/dimension/time" typeof="qb:ComponentSpecification"><span rel="qb:componentProperty qb:dimension" resource="sdmx-dimension:timePeriod" typeof="qb:DimensionProperty"><span property="skos:prefLabel">Time Period</span></span></th>
                <th rel="qb:component" resource="component/{$dataset}/measure/latitude" typeof="qb:ComponentSpecification"><span rel="qb:componentProperty qb:measure" resource="wgs:lat" typeof="qb:ComponentProperty qb:MeasureProperty"><span property="skos:prefLabel" rel="rdfs:subPropertyOf" resource="sdmx-measure:obsValue">Latitude</span></span></th>
                <th rel="qb:component" resource="component/{$dataset}/measure/longitude" typeof="qb:ComponentSpecification"><span rel="qb:componentProperty qb:measure" resource="wgs:lon" typeof="qb:ComponentProperty qb:MeasureProperty"><span property="skos:prefLabel" rel="rdfs:subPropertyOf" resource="sdmx-measure:obsValue">Longitude</span></span></th>
                <th rel="qb:component" resource="component/{$dataset}/measure/elevation" typeof="qb:ComponentSpecification"><span rel="qb:componentProperty qb:measure" resource="wgs:ele" typeof="qb:ComponentProperty qb:MeasureProperty"><span property="skos:prefLabel" rel="rdfs:subPropertyOf" resource="sdmx-measure:obsValue">Elevation</span></span></th>
                <xsl:if test="trkpt[1]/extensions/gpxtpx:TrackPointExtension/gpxtpx:hr">
                <th rel="qb:component" resource="component/{$dataset}/measure/heart-rate" typeof="qb:ComponentSpecification"><span rel="qb:componentProperty qb:measure" resource="qudt-unit:HeartBeatsPerMinute" typeof="qb:ComponentProperty qb:MeasureProperty"><span property="skos:prefLabel" rel="rdfs:subPropertyOf" resource="sdmx-measure:obsValue">Heart rate</span></span></th>
                </xsl:if>
            </tr>
        </thead>
        <tfoot>
    ...
    <xsl:template match="gpxtpx:hr">
        <td property="qudt-unit:HeartBeatsPerMinute" datatype="xsd:nonNegativeInteger"><xsl:value-of select="normalize-space(.)"/></td>
    </xsl:template>
